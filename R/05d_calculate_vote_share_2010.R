...
# unzip data
temp_dir_1 <- tempdir()
all_zip_files <- list.files("../../data_raw/urnas_2010", full.names = T, pattern = '.zip')
temp_zip <- all_zip_files[all_zip_files %like% 2010]
...
dir.create('../../data/votes_2010')
fwrite(votos, '../../data/votes_2010/votos_T1_T2.csv')
