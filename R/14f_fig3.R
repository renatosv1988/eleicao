...
fig1_a <- readRDS('./figures2/fig_3A.rds')
fig1_b <- readRDS('./figures2/fig_3B.rds')
fig1_c <- readRDS('./figures2/fig_3C.rds')
fig1_d <- readRDS('./figures2/fig_3D.rds')
...
ggsave(plot=p1, file= './figures2/f3_final.pdf', 
